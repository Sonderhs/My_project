...
from GraphConvolutionLayer import GCNConv
# from GraphAttentionLayer import GATConv
from My_GAT import GATConv
...
if __name__ == "__main__":
    ...
    model = GNN(in_channels=dataset.num_node_features, hidden_channels=args.hidden_dim,
                out_channels=dataset.num_classes, model_type='GAT', dropout_rate=args.dropout_rate).to(device)
    print(model)
